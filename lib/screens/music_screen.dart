...
class MusicScreen extends StatefulWidget {
  ...
  double height;
  int index;
  MusicScreen(this.ref, this.data, this.height, this.index);
...
// class MusicScreen extends StatefulWidget {
//   BuildContext ctx;
//   MusicScreen(this.ctx, {Key? key}) : super(key: key);
//
//   @override
//   _MusicScreenState createState() => _MusicScreenState();
// }
...
//   @override
//   Widget build(BuildContext context) {
//     p = Provider.of<MyAudio>(widget.ctx);
